...
export function BellOff(p: Props) {
  return (
    <svg {...baseProps} {...p}>
...
export function Sparkles(p: Props) {
  return (
    <svg {...baseProps} {...p}>
      ...
      <path d="M19 14l.7 1.9L22 17l-2.3.7L19 20l-.7-2.3L16 17l2.3-1.1L19 14z" />
      <path d="M5 14l.7 1.9L8 17l-2.3.7L5 20l-.7-2.3L2 17l2.3-1.1L5 14z" />
    </svg>
  );
}

export function Moon(p: Props) {
  return (
    <svg {...baseProps} {...p}>
...
export function Telescope(p: Props) {
  return (
    <svg {...baseProps} {...p}>
      <path d="M10.065 12.493l-6.18 1.318a.934.934 0 0 1-1.108-.702l-.537-2.15a1.07 1.07 0 0 1 .691-1.265l13.504-4.44" />
      <path d="M13.94 9.32 18.31 7.7 16.5 4.5l-1.66.61" />
      <path d="M18.31 7.7 21 6.5 19.5 3 17 4l1.31 3.7z" />
      <path d="M11.42 12.713 14 17.5l3 .5-1.5-2.6" />
